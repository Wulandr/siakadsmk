                    ...
                    <div class="col-12 col-sm-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="div">
                                    @can('murid_create')
                                        <a href="{{ url('/murid/addNew') }}">
                                            <button href="{{ url('/murid/addNew') }}" type="button"
                                    ...
                                    <table class="table table-bordered text-nowrap mb-0" id="mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $murid->get_kelas->nama_kelas }}
                                                </td>
                                                <td class="text-center">
                                                    {{ $murid->get_th_ajaran->kode }}
                                                </td>
                                                <td class="text-center">
                                                    <div class="flex align-items-center list-user-action">
                                                        @can('murid_update')
                                                            <a href="{{ url('/murid/edit/' . base64_encode($murid->id)) }}"
                                                        ...
                                                        @endcan
                                                        @can('murid_delete')
                                                            <a href="{{ url('/murid/delete/' . base64_encode($murid->id)) }}"
