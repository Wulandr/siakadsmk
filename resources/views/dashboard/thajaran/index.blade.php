                    ...
                    <div class="col-12 col-sm-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="div">
                                    @can('thajaran_create')
                                        <a href="{{ url('/thajaran/addNew') }}">
                                            <button href="{{ url('/thajaran/addNew') }}" type="button"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="flex align-items-center list-user-action">
                                                        @can('thajaran_update')
                                                            <a href="{{ url('/thajaran/edit/' . base64_encode($thajaran->id)) }}"
                                                        ...
                                                        @endcan
                                                        @can('thajaran_delete')
                                                            <a href="{{ url('/thajaran/delete/' . base64_encode($thajaran->id)) }}"
