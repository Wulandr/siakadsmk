                    ...
                    <div class="col-12 col-sm-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="div">
                                    @can('kelas_create')
                                        <a href="{{ url('/kelas/addNew') }}">
                                            <button href="{{ url('/kelas/addNew') }}" type="button"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $kelas->get_wali_kelas($kelas->wali_kelas)->nama }}
                                                </td>
                                                <td class="text-center">
                                                    <div class="flex align-items-center list-user-action">
                                                        @can('kelas_update')
                                                            <a href="{{ url('/kelas/edit/' . base64_encode($kelas->id)) }}"
                                                        ...
                                                        @endcan
                                                        @can('kelas_delete')
                                                            <a href="{{ url('/kelas/delete/' . base64_encode($kelas->id)) }}"
