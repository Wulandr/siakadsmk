                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="main-content-label mg-b-5">
                                    <h5 class="card-title mg-b-20">Edit Guru</h5>
                                </div>
                                <form action="{{ url('/guru/edit/process/' . base64_encode($id)) }}" id="formData"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jabatan" required>
                                            ...
                                            <option value="Wali Kelas"
                                                {{ $guru->jabatan == 'Wali Kelas' ? 'selected' : '' }}>Wali Kelas
                                            </option>
                                            <option value="Guru BK" {{ $guru->jabatan == 'Guru BK' ? 'selected' : '' }}>
                                                Guru BK</option>
                                        </select>
                                    </div>
                                    <?php } ?>
