        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="index.html" class="header-logo">
                    <img src="{{ asset('nowa/assets/img/brand/logo (1).png') }}" class="mobile-logo logo-1" alt="logo">
                    <img src="{{ asset('nowa/assets/img/brand/logo (1).png') }}" class="mobile-logo dark-logo-1"
                        alt="logo">
                </a>
            </div>
            ...
            <div class="logo-horizontal">
                <a href="index.html" class="header-logo">
                    <img src="{{ asset('nowa/assets/img/brand/logo (1).png') }}" class="mobile-logo logo-1"
                        alt="logo">
                    <img src="{{ asset('nowa/assets/img/brand/logo (1).png') }}" class="mobile-logo dark-logo-1"
                        alt="logo">
                </a>
                                ...
                                <div class="main-message-list chat-scroll">
                                    <a href="chat.html" class="dropdown-item d-flex border-bottom">
                                        <div class="  drop-img  cover-image  "
                                            data-image-src="{{ asset('nowa/assets/img/faces/3.jpg') }}">
                                    ...
                                    <a href="chat.html" class="dropdown-item d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-image-src="{{ asset('nowa/assets/img/faces/2.jpg') }}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <a href="chat.html" class="dropdown-item d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-image-src="{{ asset('nowa/assets/img/faces/9.jpg') }}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <a href="chat.html" class="dropdown-item d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-image-src="{{ asset('nowa/assets/img/faces/12.jp') }}g">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <a href="chat.html" class="dropdown-item d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-image-src="{{ asset('nowa/assets/img/faces/5.jpg') }}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
                            <a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown">
                                @if (!empty(Auth::user()->image))
                                    <img alt="" src="{{ asset('imageprofil/' . Auth::user()->image) }}"
                                        class="">
                                @else
                            ...
                            document.getElementById('logout-form').submit();"
                                    role="button"><i class="far fa-arrow-alt-circle-left"></i> Sign Out</a>
